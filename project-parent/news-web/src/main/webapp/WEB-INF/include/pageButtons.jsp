...
<c:if test="${pageContext.request.getParameter('page')>1}">
    <a class="page-btn"
       href="${pageContext.request.contextPath}/articleList?page=${pageContext.request.getParameter("page")-1}">< </a>
</c:if>

<c:forEach items="${pages}" var="page">
    <a class="page-btn"
       <c:if test="${pageContext.request.getParameter('page')==page}">style="color: #007bff" </c:if>
       href="${pageContext.request.contextPath}/articleList?page=${page}"> ${page} </a>
</c:forEach>
